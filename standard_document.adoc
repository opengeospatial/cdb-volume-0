...
:titletext: Volume 0: Primer for the OGC CDB Standard: Model and Physical Data Store Structure
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/BP/cdb-core-primer/1.1
...
|Internal reference number of this OGC(R) document:        15-120r5
|Version: 1.1
