:Title: Volume 0: OGC CDB Companion Primer for the CDB standard (Best Practice)
:titletext: Volume 0: OGC CDB Companion Primer for the CDB standard (Best Practice)
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
include::clause_5_UsingOGCStandardsWithACDBStructuredDataStore.adoc[]

include::clause_6_BackgroundAndInformativeMaterial.adoc[]
