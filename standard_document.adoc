...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/BP/cdb-core-primer/1.3
|Internal reference number of this OGC(R) document:        15-120r7
|Version: 1.3
